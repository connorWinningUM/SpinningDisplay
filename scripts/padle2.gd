...
@onready var rotate_sensitivity = get_parent().get_node("PauseMenu2").get_node("VBoxContainer").get_node("RotationSensitivity").get_node("HSlider").value;
...
func _process(delta: float) -> void:
	...
	SPEED = get_parent().get_node("PauseMenu2").get_node("VBoxContainer").get_node("Sensitivity").get_node("HSlider").value
	rotate_sensitivity = get_parent().get_node("PauseMenu2").get_node("VBoxContainer").get_node("RotationSensitivity").get_node("HSlider").value;
...
func _physics_process(delta: float) -> void:
	...
	var input_dir := Input.get_vector("P2Right", "P2Left", "P2Down", "P2Up")
	...
	var rotate := Input.get_axis("P2PushUp", "P2PushDown")
	if rotate != 0:
	...
	rotate = Input.get_axis("P2PushLeft", "P2PushRight")
	if rotate != 0:
